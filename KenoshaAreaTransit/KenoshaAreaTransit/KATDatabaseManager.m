...
-(BOOL)createDB {
    ...
    if ([filemgr fileExistsAtPath: databasePath ] == NO) {
        ...
        if (sqlite3_open(dbpath, &database) == SQLITE_OK) {
            char *errMsg;
            const char *sql_stmt = "create table if not exists `kat` (_id int(4) NOT NULL, AUTO_INCREMENT, route INTEGER DEFAULT NULL, location TEXT, day BOOLEAN, time DATETIME DEFAULT NULL ";
