...
//            char *errMsg;
//            const char *sql_stmt = "create table if not exists routetable (_id int(6) DEFAULT NULL PRIMARY KEY auto_increment, route int(3) DEFAULT NULL, location VARCHAR(256), day BOOLEAN, time DATETIME DEFAULT NULL ";
